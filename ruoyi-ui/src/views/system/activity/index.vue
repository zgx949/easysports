<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="开始时间" prop="startTime">
        <el-date-picker clearable
          ...
          type="datetime"
          value-format="yyyy-MM-dd yyyy-MM-dd h:m:s"
          placeholder="请选择开始时间">
        </el-date-picker>
      </el-form-item>
      ...
      <el-form-item label="进程" prop="status">
    ...
    <el-table v-loading="loading" :data="activityList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="体测活动名" align="center" prop="name" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="体测名" prop="name">
          <el-input v-model="form.name" placeholder="请输入体测名" />
        </el-form-item>
        <el-form-item label="开始时间" prop="startTime">
          <el-date-picker clearable
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        name: [
          { required: true, message: "体测活动名不能为空", trigger: "blur" }
        ],
        startTime: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除体测编号为"' + ids + '"的数据项？').then(function() {
