<template>
  <div>
    <h1 style="text-align: center">坐位体前屈成绩录入</h1>
    <el-row :gutter="15">
      <el-form
        ref="elForm"
        :model="formData"
    ...
    <div v-for="(data, index) in userDatas" :key="index">
      <el-card class="box-card">
        ...
        <div class="text item">
          成绩：
          <el-select v-model="data.score" placeholder="请选择" size="small" style="width: 30%">
            <el-option
              v-for="item in 150"
              :key="item - 40"
              :label="item - 40"
          ...
          <el-select v-model="data.score1" placeholder="请选择" size="small" style="width: 30%">
            <el-option
              v-for="item in 100"
              :key="item - 1"
              :label="item - 1"
